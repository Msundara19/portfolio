        ...
        <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 justify-center lg:justify-start">
              <a href="https://drive.google.com/file/d/1guXkjtwpvPNHlhsIAfVpX4x9dgw7iIB7/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className={`px-5 py-2.5 rounded-lg font-medium transition-all hover:scale-105 text-sm ${darkMode ? 'bg-white text-black hover:bg-zinc-200' : 'bg-zinc-900 text-white hover:bg-zinc-800'}`}>View Resume</a>
