    ...
    <div className={`min-h-screen transition-colors duration-500 ${darkMode ? 'bg-black text-white' : 'bg-zinc-50 text-zinc-900'}`}>
      ...
      <nav className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
        <div className={`flex items-center gap-1 px-3 py-2.5 rounded-2xl backdrop-blur-xl border ${darkMode ? 'bg-zinc-900/80 border-zinc-800' : 'bg-white/80 border-zinc-200 shadow-xl'}`}>
          <button onClick={() => scrollToSection('home')} className={`p-2.5 rounded-xl transition-all ${activeSection === 'home' ? (darkMode ? 'bg-zinc-800' : 'bg-zinc-200') : ''}`}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
          </button>
          <button onClick={() => scrollToSection('experience')} className={`p-2.5 rounded-xl transition-all ${activeSection === 'experience' ? (darkMode ? 'bg-zinc-800' : 'bg-zinc-200') : ''}`}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </button>
          <button onClick={() => scrollToSection('projects')} className={`p-2.5 rounded-xl transition-all ${activeSection === 'projects' ? (darkMode ? 'bg-zinc-800' : 'bg-zinc-200') : ''}`}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
            </svg>
          </button>
          <div className={`w-px h-6 ${darkMode ? 'bg-zinc-700' : 'bg-zinc-300'}`}></div>
          <a href="https://github.com/Msundara19" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl">
          ...
          <a href="https://www.linkedin.com/in/meenakshi-sridharan-89133b261/" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-xl">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
            </svg>
          </a>
          <button onClick={() => setDarkMode(!darkMode)} className="p-2.5 rounded-xl">
            {darkMode ? (
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 relative z-10">
        <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="flex-1">
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm mb-6 ${darkMode ? 'bg-zinc-900 border border-zinc-800' : 'bg-white border border-zinc-200'}`}>
            ...
            <p className={`text-xl md:text-2xl mb-8 ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
              AI Enthusiast blending logic, empathy, and code to make machines a little more human.
            </p>
            <div className="flex flex-wrap gap-4">
              <a href="/resume.pdf" target="_blank" className={`px-8 py-4 rounded-xl font-medium transition-all hover:scale-105 ${darkMode ? 'bg-white text-black hover:bg-zinc-200' : 'bg-zinc-900 text-white hover:bg-zinc-800'}`}>
                View Resume
              </a>
            ...
            <div className="mt-12 flex flex-wrap gap-2">
              {['Machine Learning and Deep Learning', 'Hardware Accelerators', 'Computer Vision', 'LLMs', 'Python'].map((tech, idx) => (
                <span key={idx} className={`px-3 py-1.5 rounded-lg text-sm ${darkMode ? 'bg-zinc-900 text-zinc-500 border border-zinc-800' : 'bg-white text-zinc-500 border border-zinc-200'}`}>
                  {tech}
                </span>
              ))}
            </div>
          ...
          <div className="flex-shrink-0 relative">
            ...
            <div className="w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-zinc-800 relative">
              <img
                src="https://avatars.githubusercontent.com/Msundara19"
                alt="Meenakshi"
                className="w-full h-full object-cover"
                onError={(e) => {
                  e.target.style.display = 'none';
                  e.target.parentElement.innerHTML = '<div class="w-full h-full bg-zinc-800 flex items-center justify-center text-6xl font-bold text-white">MS</div>';
                }}
              />
            </div>
          </div>
      ...
      <section className="py-32 px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className={`text-xl md:text-2xl leading-relaxed ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
      ...
      {/* Featured Writing Section - FIXED to display all articles */}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {writing.map((article, idx) => (
              <a
                ...
                className={`block p-8 rounded-3xl border transition-all hover:scale-[1.01] ${darkMode ? 'bg-zinc-900/50 border-zinc-800 hover:border-zinc-700' : 'bg-white border-zinc-200 hover:border-zinc-300 shadow-lg'}`}
              >
                <div className="flex flex-col gap-4">
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl flex-shrink-0 ${darkMode ? 'bg-zinc-800' : 'bg-zinc-100'}`}>
                    {article.icon}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${darkMode ? 'bg-zinc-800 text-zinc-300' : 'bg-zinc-200 text-zinc-700'}`}>
                        {article.publication}
                      </span>
                    ...
                    <p className={`mb-4 text-sm ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                      {article.excerpt}
                    </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {experience.map((exp, idx) => (
              <div key={idx} className={`p-8 rounded-3xl border transition-all hover:scale-[1.02] ${darkMode ? 'bg-zinc-900/50 border-zinc-800' : 'bg-white border-zinc-200 shadow-lg'}`}>
                <div className="flex items-start gap-4 mb-6">
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl ${darkMode ? 'bg-zinc-800' : 'bg-zinc-100'}`}>
                    {exp.logo}
                  </div>
                  <div>
                    <h3 className="font-bold text-xl mb-1">{exp.company}</h3>
                    <p className={`text-sm ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>{exp.role}</p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {exp.highlights.map((h, i) => (
                    <span key={i} className={`px-3 py-1 rounded-full text-xs ${darkMode ? 'bg-zinc-800 text-zinc-400' : 'bg-zinc-100 text-zinc-600'}`}>
                      {h}
                    </span>
                  ))}
                </div>
                <div className="flex gap-4">
                  <a href={exp.links.github} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-2 text-sm ${darkMode ? 'text-zinc-500 hover:text-white' : 'text-zinc-500 hover:text-zinc-900'}`}>
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                    </svg>
                    Code
                  </a>
                  <a href={exp.links.paper} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-2 text-sm ${darkMode ? 'text-zinc-500 hover:text-white' : 'text-zinc-500 hover:text-zinc-900'}`}>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={`p-8 rounded-3xl border transition-all hover:scale-[1.02] ${darkMode ? 'bg-zinc-900/50 border-zinc-800' : 'bg-white border-zinc-200 shadow-lg'}`}>
              <div className="flex items-center gap-3 mb-6">
                <div className={`px-3 py-1.5 rounded-full text-xs font-bold uppercase ${darkMode ? 'bg-zinc-800 text-white' : 'bg-zinc-900 text-white'}`}>
                  IEEE Published
                </div>
                <span className={`text-sm ${darkMode ? 'text-zinc-500' : 'text-zinc-400'}`}>{research.date}</span>
              </div>
              ...
              <div className="mb-6">
                <h4 className={`text-xs uppercase tracking-wider mb-3 ${darkMode ? 'text-zinc-500' : 'text-zinc-400'}`}>Key Contributions</h4>
                <div className="space-y-2">
                  {research.contributions.map((c, i) => (
                    <div key={i} className="flex items-start gap-2">
                      <svg className={`w-4 h-4 mt-0.5 ${darkMode ? 'text-zinc-600' : 'text-zinc-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className={`text-sm ${darkMode ? 'text-zinc-300' : 'text-zinc-700'}`}>{c}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div className="flex gap-4">
                <a href={research.links.paper} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium ${darkMode ? 'bg-white text-black' : 'bg-zinc-900 text-white'}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
                  Read Paper
                </a>
                <a href={research.links.github} target="_blank" rel="noopener noreferrer" className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-sm ${darkMode ? 'border-zinc-700' : 'border-zinc-300'}`}>
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                  </svg>
                  Code
            ...
            {education.map((edu, idx) => (
              <div key={idx} className={`p-8 rounded-3xl border ${darkMode ? 'bg-zinc-900/30 border-zinc-800' : 'bg-zinc-50 border-zinc-200'}`}>
                <div className="flex items-center gap-4 mb-4">
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center text-lg font-bold ${darkMode ? 'bg-zinc-800 text-white' : 'bg-zinc-200 text-zinc-700'}`}>
                    {edu.logo}
                  </div>
                  <div>
                    <h3 className="font-bold text-lg">{edu.school}</h3>
                    <p className={`text-sm ${darkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>{edu.degree}</p>
                    <p className={`text-xs ${darkMode ? 'text-zinc-600' : 'text-zinc-400'}`}>{edu.period}</p>
                  </div>
                </div>
                <div className="flex flex-wrap gap-2 ml-[4.5rem]">
                  {edu.courses.map((course, i) => (
                    <span key={i} className={`px-3 py-1 rounded-lg text-xs ${darkMode ? 'bg-zinc-800 text-zinc-400' : 'bg-white text-zinc-600 border border-zinc-200'}`}>
                      {course}
                    </span>
                  ))}
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(skills).map(([category, items]) => (
              <div key={category} className={`p-6 rounded-2xl border ${darkMode ? 'bg-zinc-900/50 border-zinc-800' : 'bg-white border-zinc-200 shadow-lg'}`}>
                <h3 className={`font-bold text-sm uppercase tracking-wider mb-4 ${darkMode ? 'text-zinc-400' : 'text-zinc-500'}`}>
                  {category}
                </h3>
                <div className="flex flex-wrap gap-2">
                  {items.map((skill, i) => (
                    <span key={i} className={`px-3 py-1.5 rounded-lg text-sm ${darkMode ? 'bg-zinc-800 text-zinc-300' : 'bg-zinc-100 text-zinc-700'}`}>
                      {skill}
                    </span>
                  ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project, idx) => (
              <div
                key={idx}
                className={`group rounded-3xl overflow-hidden transition-all hover:scale-[1.02] cursor-pointer ${darkMode ? 'bg-zinc-900 border border-zinc-800' : 'bg-white border border-zinc-200 shadow-xl'}`}
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className={`absolute top-4 left-4 w-10 h-10 rounded-xl flex items-center justify-center text-xl ${darkMode ? 'bg-zinc-800/80' : 'bg-white/80'} backdrop-blur-sm`}>
                    {project.icon}
                  </div>
                  {project.hackathon && (
                    <a
                      ...
                      className="absolute top-4 right-4 px-2 py-1 rounded-lg text-xs font-medium bg-white/20 text-white backdrop-blur-sm hover:bg-white/30 transition-colors"
                    >
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <p className="text-zinc-300 text-sm">{project.shortDesc}</p>
                  </div>
                </div>
                <div className="p-5">
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.slice(0, 3).map((tag, i) => (
                      <span key={i} className={`px-2 py-1 rounded-lg text-xs ${darkMode ? 'bg-zinc-800 text-zinc-400' : 'bg-zinc-100 text-zinc-600'}`}>
                        {tag}
                      </span>
                    ))}
                  </div>
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" onClick={() => setSelectedProject(null)}>
          ...
          <div
            className={`relative max-w-3xl w-full max-h-[90vh] overflow-y-auto rounded-3xl ${darkMode ? 'bg-zinc-900' : 'bg-white'}`}
            onClick={(e) => e.stopPropagation()}
          >
            <div className="relative h-64">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                {selectedProject.hackathon && (
                  <a
                    href={selectedProject.hackathon.link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium bg-white/20 text-white backdrop-blur-sm hover:bg-white/30 mb-2"
                  >
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {selectedProject.tags.map((tag, i) => (
                    <span key={i} className="px-3 py-1 rounded-full text-xs font-medium bg-white/20 text-white backdrop-blur-sm">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mb-8">
                ...
                <p className={darkMode ? 'text-zinc-400' : 'text-zinc-600'}>{selectedProject.caseStudy.challenge}</p>
              </div>
              <div className="mb-8">
                <h3 className="font-bold text-lg mb-3">The Approach</h3>
                <p className={darkMode ? 'text-zinc-400' : 'text-zinc-600'}>{selectedProject.caseStudy.approach}</p>
              </div>
              <div className="mb-8">
                <h3 className="font-bold text-lg mb-3">Results</h3>
                <div className="grid grid-cols-2 gap-3">
                  {selectedProject.caseStudy.results.map((r, i) => (
                    <div key={i} className={`p-3 rounded-xl ${darkMode ? 'bg-zinc-800' : 'bg-zinc-100'}`}>
                      <span className={`text-sm ${darkMode ? 'text-zinc-300' : 'text-zinc-700'}`}>{r}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedProject.caseStudy.techStack.map((t, i) => (
                    <span key={i} className={`px-4 py-2 rounded-xl text-sm ${darkMode ? 'bg-zinc-800 text-zinc-300' : 'bg-zinc-100 text-zinc-700'}`}>
                      {t}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium ${darkMode ? 'bg-zinc-800 text-white' : 'bg-zinc-200 text-zinc-900'}`}
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
                  </svg>
                ...
                {selectedProject.live && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-medium ${darkMode ? 'bg-white text-black' : 'bg-zinc-900 text-white'}`}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                    </svg>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className={darkMode ? 'text-zinc-500' : 'text-zinc-400'}>Always open to new opportunities.</p>
            </div>
            <button
              onClick={copyEmail}
              className={`px-8 py-4 rounded-xl font-medium transition-all hover:scale-105 flex items-center gap-2 ${darkMode ? 'bg-white text-black' : 'bg-zinc-900 text-white'}`}
            >
              {copied ? (
                <>
